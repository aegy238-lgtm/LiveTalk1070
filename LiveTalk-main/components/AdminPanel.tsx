...
import { 
  ...
  Crown, Smartphone, Eraser, X, Medal, IdCard, Layout, Zap, Smile, Heart, Building, Image as ImageIcon, UserCircle, Home, Menu, ChevronLeft, Sparkles, Database, UserCog, TowerControl
} from 'lucide-react';
...
import AdminProfilesSystem from './Admin/AdminProfilesSystem';
...
const AdminPanel: React.FC<AdminPanelProps> = (props) => {
  ...
  const menuItems = [
    ...
    { id: 'profile_hub', label: 'إدارة الهويات', icon: UserCog, color: 'text-emerald-400' },
    { id: 'tribes', label: 'إدارة القبائل', icon: TowerControl, color: 'text-emerald-500' },
    ...
    <div className="fixed inset-0 z-[3000] bg-[#020617] flex flex-col md:flex-row font-cairo overflow-hidden text-right" dir="rtl">
      ...
      <div className="flex-1 bg-[#020617] overflow-y-auto p-4 md:p-10 scrollbar-hide pb-20 md:pb-10 relative">
        <div className="max-w-7xl mx-auto">
            ...
            {activeTab === 'profile_hub' && <AdminProfilesSystem users={props.users} onUpdateUser={props.onUpdateUser} handleFileUpload={handleFileUpload} />}
            {activeTab === 'tribes' && <AdminTribes users={props.users} gameSettings={props.gameSettings} onUpdateGameSettings={handleUpdateGameSettings} handleFileUpload={handleFileUpload} />}
