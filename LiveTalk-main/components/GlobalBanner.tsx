...
const GlobalBanner: React.FC<GlobalBannerProps> = ({ announcement }) => {
  ...
  let bannerStyle = "bg-gradient-to-r from-purple-700 via-indigo-600 to-purple-700 border-indigo-400/30 shadow-[0_10px_30px_rgba(79,70,229,0.3)]";
  ...
  return (
    <div className="fixed top-14 left-0 right-0 z-[10000] pointer-events-none flex justify-center px-4">
      ...
      <motion.div
        ...
        className={`relative w-full max-w-[360px] flex items-center gap-3 px-4 py-2.5 rounded-full border-2 overflow-hidden ${bannerStyle}`}
      >
        <motion.div 
          animate={{ x: ['-100%', '300%'] }} 
